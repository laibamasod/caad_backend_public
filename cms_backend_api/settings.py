"""
Django settings for cms_backend_api project.
...
SECRET_KEY = 'django-insecure-l(xbkkxbr_=1xeifemu8mhgbz8xxz)erv6nq6vzuc1-8q2*45n'
...
WSGI_APPLICATION = 'cms_backend_api.wsgi.application'
